...
| Platforms | **CPU** | **EC** | **AWAC** | **NVRAM** | **USB** | **Misc** |
| :-------: | :-----: | :----: | :------: | :-------: | :-----: | :------:
| Penryn | N/A | [SSDT-EC](./Universal/ec-fix) | N/A | N/A | N/A | N/A |
...
| Rocket Lake | ^^ | ^^ | ^^ | ^^ | [SSDT-USBW](./Universal/usbw) | [SSDT-BRG0](./Universal/brg0) |
| Alder Lake | [SSDT-PLUG-ALT](./Universal/plug-alt) | ^^ | ^^ | ^^ | ^^ | ^^ |
